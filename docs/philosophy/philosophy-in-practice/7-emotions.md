[<< Back to **Philosophy in Practice**](https://pranav-gopalkrishna.github.io/philosophy/philosophy-in-practice)
...
# Introduction
_Here, we consolidate and make explicit what was implicit in the previous discussions in_ [**Philosophy in Practice**](https://pranav-gopalkrishna.github.io/philosophy/philosophy-in-practice).
...
**NOTE**: _For a discussion on the nature of anti-values,_ see: [_The Nature of Anti-Value_ from **Ethics**](https://pranav-gopalkrishna.github.io/philosophy/ethics/nature-of-anti-value.html).
...
Dealing with emotions effectively requires grasping and validating the context of the premises underlying them (for the importance of contextual clarity, see: [_Contextual Clarity_ from **Epistemology**](https://pranav-gopalkrishna.github.io/philosophy/epistemology/contextual-clarity.html)). Hence, we shall look now into contextualising emotions, so as to recognise when our emotions are valid and when they are out of context and hence invalid.
